...
namespace GYM.Models
{
    public class Branch
    {
        ...
        public Branch(string name, string email, string city, string district, string state, string personalIdentity, string numberRegister, string telephone, DateTime fundation, StatusRegister statusRegister, Company company)
        {
            Name = name;
            Email = email;
            City = city;
